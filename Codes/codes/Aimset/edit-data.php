...
if($crud->update($id, $ami_name_ff, $ff_timestamp_ff, $Date_from_ff, $Date_to_ff, $remarks_aim_ff, $self_percentage_ff, $current_status_ff, $post_owner_ff)){
...
<div class="form-group">
<label for="Self Percentage (only number +)" style="color: #eb7700">Self Percentage (only number +)</label>*

...
if($crud->create($time_stamp_expences_ff, $expense_date_ff, $AmountSpend_ff, $Spend_mode_ff, $progressive_spend_ff, $spend_planning_ff, $remarks_spend_ff, $post_owner_ff)){

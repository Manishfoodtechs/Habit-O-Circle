...
if($crud->update($id, $habbit_timestamp_ff, $control_start_date_ff, $control_end_date_ff, $status_date_ff, $self_progress_ff, $remarks_habbit_ff, $next_estimation_date_ff, $make_public_ff, $post_owner_ff)){
...
<input class="form-control" type="text" id="post_owner" name= "post_owner" placeholder="" value="<?php echo htmlspecialchars($post_owner);?>" readonly title="<?php echo $post_ownerErr_tip;?>"required />

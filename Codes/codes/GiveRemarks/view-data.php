...
echo "<td>";
echo "<a style='pointer-events: none' href="."edit-data.php?id=".$user_data['id']." class=".' ><center><i class="fa fa-pencil-square fa-2x" aria-hidden="true"></i><center></a>';
echo "</td>";
echo "<td>";
echo "<a style='pointer-events: none' href="."delete-data.php?id=".$user_data['id']." class=".' ><center><i class="fa fa-trash fa-2x" aria-hidden="true"></i><center></a>';
echo "</td>";
echo "</tr>";
}

...
if($crud->update($id, $time_stamp_habbit_ff, $control_start_date_ff, $control_end_date_ff, $status_date_ff, $self_progress_ff, $remarks_habbit_ff, $next_estimation_date_ff, $remarks_by_friend_name_ff, $remarks_by_friend_ff, $post_owner_ff)){
...
<input readonly class="form-control" type="text" id="remarks_by_friend_name" name= "remarks_by_friend_name" placeholder="" value="<?php echo htmlspecialchars($remarks_by_friend_name);?>" title="<?php echo $remarks_by_friend_nameErr_tip;?>"required />
